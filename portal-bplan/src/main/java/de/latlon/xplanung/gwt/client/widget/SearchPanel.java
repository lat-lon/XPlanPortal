...
public class SearchPanel extends VLayout {
     ...
     *
     * @param mapModel The map's model. It knows what layers we can search in.
     * @param parent   The map's parent widget. We use this to attach the search layout to.
     */
     ...
     *
     * @param panel The search or the grid panel to show.
     */
